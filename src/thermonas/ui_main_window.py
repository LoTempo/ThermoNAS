...
################################################################################
## Form generated from reading UI file 'resources/main_window.ui'
##
...
"}")
        ...
        self.gridLayout.addWidget(self.pushButton_3, 14, 2, 1, 2)
...
"font-size: 12pt;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_F_keff.setText(QCoreApplication.translate("MainWindow", u"0.239", None))
        ...
        self.lineEdit_poros.setText(QCoreApplication.translate("MainWindow", u"0.7", None))
        ...
        self.lineEdit_S_keff.setText(QCoreApplication.translate("MainWindow", u"0.082", None))
        ...
        self.pushButton_3.setText(QCoreApplication.translate("MainWindow", u"Suggest time step", None))
    # retranslateUi
